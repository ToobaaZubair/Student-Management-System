...
class Student {
    constructor(public name: string,public fathername:string, public age: number, public studentId: string, public gender: string) {}
}
...
class StudentManagementSystem {
    ...
    async displayStudentInfo(): Promise<void> {
